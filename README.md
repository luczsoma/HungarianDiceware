...
Choosing six Diceware words yields ~77.549 bits of entropy; this should be enough for everyday use cases. Ten words yields ~129.248 bits of entropy; this is already more than the classic 128-bit security level, and its security margin will most likely hold until the arrival of quantum computers. Twenty words yields ~258.426 bits of entropy; according to our current knowledge, it means quantum-resistance.
